...
/**
 * The base model interface for the Book service. Represents a row in the &quot;BB_Book&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.imsw.model.impl.BookModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.imsw.model.impl.BookImpl}.
 * </p>
 *
 * @author User
 * @see Book
...
public interface BookModel extends BaseModel<Book>, StagedGroupedModel {
	...
	@Override
	public CacheModel<com.imsw.model.Book> toCacheModel();
