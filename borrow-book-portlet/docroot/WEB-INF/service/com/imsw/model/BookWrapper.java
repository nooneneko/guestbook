...
public class BookWrapper implements Book, ModelWrapper<Book> {
	...
	*/
	...
	/**
	* Returns the cost of this book.
	*
	* @return the cost of this book
	*/
	@Override
	public int getCost() {
		return _book.getCost();
	}

	/**
	* Sets the cost of this book.
	*
	...
	*/
	...
	@Override
	public int compareTo(com.imsw.model.Book book) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.imsw.model.Book> toCacheModel() {
		return _book.toCacheModel();
	}

	@Override
	public com.imsw.model.Book toEscapedModel() {
		return new BookWrapper(_book.toEscapedModel());
	}

	@Override
	public com.imsw.model.Book toUnescapedModel() {
