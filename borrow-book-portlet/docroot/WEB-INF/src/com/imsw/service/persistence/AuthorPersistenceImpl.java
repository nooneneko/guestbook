...
import com.imsw.NoSuchAuthorException;

import com.imsw.model.Author;
import com.imsw.model.impl.AuthorImpl;
import com.imsw.model.impl.AuthorModelImpl;
...
public class AuthorPersistenceImpl extends BasePersistenceImpl<Author>
	...
	@Override
	public Author updateImpl(com.imsw.model.Author author)
		throws SystemException {
		author = toUnwrappedModel(author);
	...
	protected Author toUnwrappedModel(Author author) {
		...
		authorImpl.setAddress(author.getAddress());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.imsw.model.Author")));
