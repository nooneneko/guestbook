...
public class GuestBookServiceClp implements GuestBookService {
	public GuestBookServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getGuestbooks";

		_methodParameterTypes3 = new String[] { "long", "int" };

		_methodName4 = "getGuestbooks";

		_methodParameterTypes4 = new String[] { "long", "int", "int" };

		_methodName5 = "getGuestbooksCount";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "addGuestBook";
	...
	public java.util.List<com.liferay.docs.guestbook.model.GuestBook> getGuestbooks(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { groupId, status });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
