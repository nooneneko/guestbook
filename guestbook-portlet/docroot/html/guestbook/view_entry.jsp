...
<%
        ...
        PortalUtil.addPortletBreadcrumbEntry(request, entry.getName(),
                        currentURL);

        PortalUtil.setPageSubtitle(entry.getName(), request);
        PortalUtil.setPageDescription(entry.getName(), request);
