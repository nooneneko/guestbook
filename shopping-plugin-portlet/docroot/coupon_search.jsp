...
<aui:script>
	function <portlet:namespace />addCoupon() {
		...
		submitForm(document.<portlet:namespace />fm, '<portlet:renderURL><portlet:param name="jspPage" value="/edit_coupon.jsp" /><portlet:param name="redirect" value="<%= currentURL %>" /></portlet:renderURL>');
	}
